              ...
              <div className="sm:flex sm:justify-between sm:items-center mb-8">
                ...
                <div className="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-4">
                  ...
                  <div className="flex shrink-0 -space-x-3 -ml-px">
                    ...
                    <button className="flex justify-center items-center w-9 h-9 rounded-full bg-white border border-slate-200 hover:border-slate-300 color-primary shadow-sm transition duration-150 ml-2">
                    ...
                    <div className="bg-white shadow-lg rounded-sm border border-slate-200 p-4" draggable="true">
                      <div className="sm:flex sm:justify-between sm:items-start">
                        ...
                        <div className="grow mt-0.5 mb-3 sm:mb-0 space-y-3">
                          <div className="flex items-center">
                            ...
                            <label className="flex items-center">
                              <input type="checkbox" className="peer focus:ring-0 focus-visible:ring w-5 h-5 bg-white border border-slate-200 color-primary rounded-full" />
                        ...
                        <div className="flex items-center justify-end space-x-3">
                          ...
                          {/* Like button */}
                          <button className="flex items-center text-slate-400 hover:color-primary">
                          ...
                          {/* Attach button */}
                          <button className="text-slate-400 hover:color-primary">
                            <svg className="w-4 h-4 shrink-0 fill-current mr-1.5" viewBox="0 0 16 16">
                      ...
                      <div className="sm:flex sm:justify-between sm:items-start">
                        ...
                        <div className="grow mt-0.5 mb-3 sm:mb-0 space-y-3">
                          ...
                          <ul className="pl-12 space-y-3">
                            <li>
                              <label className="flex items-center">
                                <input type="checkbox" className="peer focus:ring-0 focus-visible:ring w-5 h-5 bg-white border border-slate-200 color-primary rounded-full" defaultChecked />
