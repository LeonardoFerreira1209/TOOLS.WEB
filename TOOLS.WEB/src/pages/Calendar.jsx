            ...
            <div className="sm:flex sm:justify-between sm:items-center mb-4">
              ...
              <div className="mb-4 sm:mb-0 mr-2">
                <ul className="flex flex-wrap items-center -m-1">
                  ...
                  <li className="m-1">
                    <button className="btn-sm bg-white border-slate-200 hover:border-slate-300 color-primary">+Add New</button>
                  </li>
                </ul>
              </div>
              ...
              <div className="flex flex-nowrap -space-x-px">
                <button className="btn bg-slate-50 border-slate-200 hover:bg-slate-50 color-primary rounded-none first:rounded-l last:rounded-r">Month</button>
