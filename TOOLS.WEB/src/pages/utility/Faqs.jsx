            ...
            <div className="max-w-3xl m-auto">
              ...
              <div className="mb-8 border-b border-slate-200">
                <ul className="text-sm font-medium flex flex-nowrap -mx-4 sm:-mx-6 lg:-mx-8 overflow-x-scroll no-scrollbar">
                  <li className="pb-3 mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
                    <a className="color-primary whitespace-nowrap" href="#0">Popular</a>
                  </li>
                  <li className="pb-3 mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
              ...
              <div>
                  ...
                  <header className="flex items-start mb-2">
                    <div className="mt-2 mr-3">
                      <svg className="w-4 h-4 shrink-0 fill-current" viewBox="0 0 16 16">
                        <path className="color-primary" d="M4 8H0v4.9c0 1 .7 1.9 1.7 2.1 1.2.2 2.3-.8 2.3-2V8z" />
                        <path className="color-primary" d="M15 1H7c-.6 0-1 .4-1 1v11c0 .7-.2 1.4-.6 2H13c1.7 0 3-1.3 3-3V2c0-.6-.4-1-1-1z" />
                      </svg>
                    </div>
                  ...
                  <div className="pl-7">
                    ...
                    <ul className="flex flex-wrap">
                      <li className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                        <a className="text-sm font-medium color-primary hover:color-primary" href="#0">General</a>
                      </li>
                      <li className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                        <a className="text-sm font-medium color-primary hover:color-primary" href="#0">Marketing</a>
                      </li>
                    </ul>
                  </div>
                </article>
                ...
                <article className="py-4 border-b border-slate-200">
                  ...
                  <div className="pl-7">
                    ...
                    <ul className="flex flex-wrap">
                      <li className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                        <a className="text-sm font-medium color-primary hover:color-primary" href="#0">Development</a>
                      </li>
                      <li className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                        <a className="text-sm font-medium color-primary hover:color-primary" href="#0">Acessibility</a>
                      </li>
                    </ul>
                  </div>
                </article>
                ...
                <article className="py-4 border-b border-slate-200">
                  ...
                  <div className="pl-7">
                    ...
                    <ul className="flex flex-wrap">
                      ...
                      <li className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                        <a className="text-sm font-medium color-primary hover:color-primary" href="#0">Plans</a>
                      </li>
                    </ul>
                  </div>
                </article>
                ...
                <article className="py-4 border-b border-slate-200">
                  ...
                  <div className="pl-7">
                    ...
                    <ul className="flex flex-wrap">
                      ...
                      <li className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                        <a className="text-sm font-medium color-primary hover:color-primary" href="#0">Account</a>
                      </li>
                    </ul>
                  </div>
                </article>
                ...
                <article className="py-4 border-b border-slate-200">
                  ...
                  <div className="pl-7">
                    ...
                    <ul className="flex flex-wrap">
                      ...
                      <li className="flex items-center after:block after:content-['·'] last:after:content-[''] after:text-sm after:text-slate-400 after:px-2">
                        <a className="text-sm font-medium color-primary hover:color-primary" href="#0">Accessibility</a>
                      </li>
                    </ul>
                  </div>
                </article>
              ...
              <div className="mt-6">
                <div className="flex justify-end">
                  <a className="btn bg-white border-slate-200 hover:border-slate-300 color-primary" href="#0">See All Questions -&gt;</a>
                </div>
              </div>
