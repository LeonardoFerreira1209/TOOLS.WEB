            ...
            <form>
              <div className='grid gap-2 grid-cols-2'>
                <div>
                  ...
                  <input onChange={onChange} value={values.firstName} id="firstName" name='firstName' className="form-input w-full" placeholder='Leonardo' type="firstName" />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-1" htmlFor="lastName">Sobrenome<span className="text-rose-500">*</span></label>
                  <input onChange={onChange} value={values.lastName} id="lastName" name='lastName' className="form-input w-full" placeholder='Almeida' type="text" />
                </div>
              </div>
              <div className='grid gap-5 md:grid-cols-2'>
                <div>
                  ...
                  <input onChange={onChange} value={values.username} id="username" name='username' className="form-input w-full" type="username" placeholder='Leo.Almeida' autoComplete="on" />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-1" htmlFor="password">Senha<span className="text-rose-500">*</span></label>
                  <input onChange={onChange} value={values.password} id="password" name='password' className="form-input w-full" type="password" placeholder='Example@11011' autoComplete="on" />
                </div>
              </div>
              <div className='grid gap-5 md:grid-cols-2'>
                <div>
                  <label className="block text-sm font-medium mb-1" htmlFor="email">E-mail<span className="text-rose-500">*</span></label>
                  <input onChange={onChange} value={values.email} id="email" name='email' className="form-input w-full" type='email'placeholder='example@example.com' autoComplete="on" />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-1" htmlFor="phoneNumber">Celular<span className="text-rose-500">*</span></label>
                  <InputMask mask={'(99)99999-9999'} onChange={onChange} value={values.phoneNumber} id="phoneNumber" name='phoneNumber' className="form-input w-full" type="phoneNumber" placeholder='(18)99776-2452' autoComplete="on"/>
                </div>
              </div>
              <div className="grid gap-5 md:grid-cols-2">
                <div>
                ...
                <div>
                  ...
                  <InputMask mask={'999.999.999-99'} onChange={onChange} value={values.cpf} id="cpf" name='cpf' className="form-input w-full" type="cpf" placeholder='xxx.xxx.xxx-xx' autoComplete="on" />
                </div>
              </div>
               {/* Error */}
               { error !== null ? (
              ...
              <div className="flex items-center justify-between mt-6">
                ...
                <button onClick={Create} className="btn bg-gradient-primary-500 text-white ml-3 whitespace-nowrap">
                {
