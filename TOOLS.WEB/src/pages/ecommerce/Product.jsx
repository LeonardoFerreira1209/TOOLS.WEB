        ...
        <main>
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full">
            ...
            <div className="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
              ...
              <div>
                <div className="mb-3">
                  <a className="text-sm font-medium color-primary hover:color-primary" href="#0">&lt;- Back To Listing</a>
                </div>
                ...
                <div>
                  ...
                  <div className="text-center">
                    <button className="btn bg-white border-slate-200 hover:border-slate-300 color-primary hover:text-slate-600">Load More Reviews</button>
                  </div>
                </div>
                ...
                <div>
                  ...
                  {/* Load More */}
                  <div className="text-center">
                    <button className="btn bg-white border-slate-200 hover:border-slate-300 color-primary hover:text-slate-600">Load More Stuff</button>
                  </div>
                </div>
                  ...
                  <ul className="space-y-2 sm:flex sm:space-y-0 sm:space-x-2 lg:space-y-2 lg:space-x-0 lg:flex-col mb-4">
                    ...
                    <li>
                      <button className="w-full h-full text-left py-3 px-4 rounded bg-white border-2 border-indigo-400 shadow-sm duration-150 ease-in-out">
                        <div className="flex flex-wrap items-center justify-between mb-0.5">
                          <span className="font-semibold text-slate-800">Premium <span className="text-xs italic color-primary align-top">Best Value ✨</span></span>
