          ...
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full">
            ...
            <div className="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
              ...
              <div>
                ...
                <div className="text-sm font-semibold color-primary uppercase mb-2">Mon 27 Dec, 2021 - 9:00 PM -&gt; 10:00 PM</div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white p-5 shadow-lg rounded-sm border border-slate-200 lg:w-72 xl:w-80">
                  <div className="flex justify-between space-x-1 mb-5">
                    ...
                    <a className="text-sm font-medium color-primary hover:color-primary" href="#0">
                      View All
                    </a>
                  </div>
