...
function Signup02() {
  ...
  function isInvalid() {
    ...
    if(values.rg === "") { setError("Preencha o campo de Registro geral!"); setLoading(false); return true; }
      ...
      <div className="md:w-1/2">
        <div className="min-h-screen h-full flex flex-col after:flex-1">
            ...
            <div className="max-w-md mx-auto w-full">
              <div className="relative">
                ...
                <ul className="relative flex justify-between w-full">
                  ...
                  <li>
                    <Link className="flex items-center justify-center w-6 h-6 rounded-full text-xs font-semibold bg-slate-100 text-slate-500" to="/signup03">3</Link>
                  </li>
                  <li>
          ...
          <div className="md:max-w-md lg:max-w-lg mx-auto px-4 py-8">
            <h1 className="text-3xl bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 to-sky-500 font-bold mb-6">Informe seus dados pessoais <b className='text-indigo-100'>✨</b></h1>
            {/* Form */}
            <form>
              ...
              <div className="flex items-center justify-between mt-6">
                <Link className="text-sm underline text-red-300 hover:no-underline" to="/signup01">&lt;- Voltar</Link>
                <Link className="btn text-white bg-gradient-to-r from-sky-500 to-indigo-500 hover:bg-gradient-to-r hover:from-indigo-500 hover:to-indigo-500 ml-auto" to="/signup03">Próximo passo -&gt;</Link>
              </div>
            </form>
          </div>
        </div>
