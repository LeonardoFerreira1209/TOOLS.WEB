...
function ModalPage() {
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      {/* Content area */}
      <div className="relative flex flex-col flex-1 verflow-y-auto overflow-x-hidden bg-white">
                      ...
                      <ModalBlank id="info-modal" modalOpen={infoModalOpen} setModalOpen={setInfoModalOpen}>
                        <div className="p-5 flex space-x-4">
                          ...
                          <div className="w-10 h-10 rounded-full flex items-center justify-center shrink-0 bg-indigo-100">
                            <svg className="w-4 h-4 shrink-0 fill-current color-primary" viewBox="0 0 16 16">
                        ...
                        <div className="mb-2 text-center">
                          ...
                          <div className="mb-3">
                            <svg className="inline-flex w-12 h-12 rounded-full shrink-0 fill-current" viewBox="0 0 48 48">
                              <rect className="color-primary" width="48" height="48" rx="24" />
                              <path className="color-primary" d="M19 16h7a8 8 0 110 16h-7V16z" />
                              <path className="color-primary" d="M26 24l-7-6v5h-8v2h8v5z" />
                            </svg>
                          </div>
                      ...
                      <ModalAction id="announcement-modal" modalOpen={announcementModalOpen} setModalOpen={setAnnouncementModalOpen}>
                        ...
                        <div className="text-center">
                          ...
                          <div className="space-y-3">
                            ...
                            <div>
                              <a className="font-medium text-sm color-primary hover:color-primary" href="#0" onClick={(e) => { e.preventDefault(); setAnnouncementModalOpen(true); }}>Not Now!</a>
                            </div>
                          </div>
                        </div>
                      </ModalAction>
                    ...
                    <div className="m-1.5">
                      ...
                      <ModalAction id="integration-modal" modalOpen={integrationModalOpen} setModalOpen={setIntegrationModalOpen}>
                        ...
                        <div className="text-sm mb-5">
                          ...
                          <div className="text-xs text-slate-500">By clicking on Allow access, you authorize Mosaic to use your information in accordance with its <a className="color-primary hover:color-primary" href="#0">Privacy Policy</a>. You can stop it at any time on the integrations page of your Mosaic account.</div>
                        </div>
                        {/* Modal footer */}
                        <div className="flex flex-wrap justify-end space-x-2">
                    ...
                    <div className="m-1.5">
                      ...
                      <ModalBlank id="news-modal" modalOpen={newsModalOpen} setModalOpen={setNewsModalOpen}>
                        ...
                        <div className="p-5">
                          ...
                          <div className="mb-2">
                            <div className="mb-3">
                              <div className="text-xs inline-flex font-medium bg-indigo-100 color-primary rounded-full text-center px-2.5 py-1">New on Mosaic</div>
                            </div>
                              ...
                              <li>
                                <button className="w-full h-full text-left py-3 px-4 rounded bg-white border border-slate-200 hover:border-slate-300 shadow-sm duration-150 ease-in-out">
                                  <div className="flex items-center">
                                    ...
                                    <div className="grow">
                                      <div className="flex flex-wrap items-center justify-between mb-0.5">
                                        <span className="font-semibold text-slate-800">Mosaic Basic <span className="text-xs italic color-primary align-top">Best Value ✨</span></span>
