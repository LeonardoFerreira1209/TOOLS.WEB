        ...
        <section>
          ...
          <ul className="space-y-5">
            ...
            <li>
              ...
              <div className="text-sm">
                Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum in voluptate velit esse cillum dolore eu fugiat <a className="font-medium color-primary hover:color-primary" href="#0">contact us</a>.
              </div>
            </li>
          </ul>
        </section>
