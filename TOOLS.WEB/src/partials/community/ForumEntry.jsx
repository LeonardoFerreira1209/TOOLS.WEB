    ...
    <article className="bg-white shadow-md rounded border border-slate-200 p-5">
      ...
      <div className="mb-2">
        <ul className="inline-flex flex-wrap text-sm font-medium">
          <li className="flex items-center">
            <Link className="text-slate-500 hover:color-primary" to="/community/forum">
              Home
            </Link>
          ...
          <li className="flex items-center">
            <a className="text-slate-500 hover:color-primary" href="#0">
              Discussion
            </a>
          </li>
        </ul>
      ...
      <div className="mt-4">
          ...
          <li className="relative pl-9 space-y-5">
            ...
            <div className="flex items-start">
              ...
              <div className="absolute top-0 left-0">
                <button className="text-xs font-semibold text-left w-6 rounded-sm flex flex-col justify-center items-center hover:color-primary">
                  <svg className="inline-flex fill-slate-400 mt-1.5 mb-1.5" width="12" height="6" xmlns="http://www.w3.org/2000/svg">
                    <path d="m0 6 6-6 6 6z" />
                  </svg>
                  <div>44</div>
        ...
        <div className="text-center mt-5">
          <button className="text-sm font-medium color-primary hover:color-primary">View More Comments</button>
        </div>
      </div>
    </article>
  );
