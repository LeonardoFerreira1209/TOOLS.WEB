        ...
        <header className="text-center sm:text-left mb-6">
          ...
          <div className="flex flex-wrap justify-center sm:justify-start space-x-4">
            ...
            <div className="flex items-center">
              ...
              <a className="text-sm font-medium whitespace-nowrap color-primary hover:color-primary ml-2" href="#0">carolinmcneail.com</a>
            </div>
          </div>
        </header>
        ...
        <div className="relative mb-6">
          ...
          <ul className="relative text-sm font-medium flex flex-nowrap -mx-4 sm:-mx-6 lg:-mx-8 overflow-x-scroll no-scrollbar">
            <li className="mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
              <a className="block pb-3 color-primary whitespace-nowrap border-b-2 border-indigo-500" href="#0">General</a>
            </li>
            <li className="mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
              ...
              <div className="grid xl:grid-cols-2 gap-4">
                ...
                <div className="bg-white p-4 border border-slate-200 rounded-sm shadow-sm">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    {/* Link */}
                    <div>
                      <a className="text-sm font-medium color-primary hover:color-primary" href="#0">View -&gt;</a>
                    </div>
                  </div>
                </div>
