    ...
    <div className="grid xl:grid-cols-2 gap-6">
      ...
      <article className="flex bg-white shadow-lg rounded-sm border border-slate-200 overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            <div className="text-sm font-semibold color-primary uppercase mb-2">Mon 27 Dec, 2021</div>
      ...
      <article className="flex bg-white shadow-lg rounded-sm border border-slate-200 overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            <div className="text-sm font-semibold color-primary uppercase mb-2">Wed 29 Dec, 2021</div>
            <Link className="inline-flex mb-2" to="/community/meetups-post">
      ...
      <article className="flex bg-white shadow-lg rounded-sm border border-slate-200 overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            <div className="text-sm font-semibold color-primary uppercase mb-2">Mon 3 Jan, 2022</div>
            <Link className="inline-flex mb-2" to="/community/meetups-post">
      ...
      <article className="flex bg-white shadow-lg rounded-sm border border-slate-200 overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            <div className="text-sm font-semibold color-primary uppercase mb-2">Thu 6 Jan, 2022</div>
            <Link className="inline-flex mb-2" to="/community/meetups-post">
      ...
      <article className="flex bg-white shadow-lg rounded-sm border border-slate-200 overflow-hidden">
        ...
        <div className="grow p-5 flex flex-col">
          <div className="grow">
            <div className="text-sm font-semibold color-primary uppercase mb-2">Fri 7 Jan, 2022</div>
            <Link className="inline-flex mb-2" to="/community/meetups-post">
