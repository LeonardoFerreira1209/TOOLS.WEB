  ...
  return (
    <div className="bg-white shadow-lg rounded-sm border border-slate-200 p-4">
      ...
      <div className="mb-3">
        ...
        {/* Content */}
        <div>
          <div className="text-sm">Dedicated form for a category of users that will perform actions? <a className="font-medium color-primary hover:color-primary" href="#0">#viewall</a></div>
        </div>
      </div>
      {/* Footer */}
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center">
          {/* Like button */}
          <button className="flex items-center text-slate-400 hover:color-primary ml-3">
          ...
          {/* Attach button */}
          <button className="text-slate-400 hover:color-primary ml-3">
            <svg className="w-4 h-4 shrink-0 fill-current mr-1.5" viewBox="0 0 16 16">
