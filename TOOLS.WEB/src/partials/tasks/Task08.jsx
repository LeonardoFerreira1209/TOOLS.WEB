  ...
  return (
    <div className="bg-white shadow-lg rounded-sm border border-slate-200 p-4">
      ...
      <div className="mb-3">
        ...
        {/* Content */}
        <div>
          <div className="text-sm">Publishing industries for previewing layouts and visual <a className="font-medium color-primary hover:color-primary" href="#0">#family</a> 🔥</div>
