      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-10 pb-12 md:pt-16 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="bg-clip-text text-transparent bg-gradient-to-r from-sky-500 to-indigo-500 h2 mb-4" data-aos="fade-up">Totalmente personalizavel para sua empresa</h2>
            <p className="text-xl text-sky-500 mb-8 bg-clip-text text-transparent bg-gradient-to-l from-indigo-400 to-sky-900" data-aos="fade-up" data-aos-delay="200">Temos suporte total a personalização do seu sistema, feito sob demanada para seu negócio</p>
          </div>
